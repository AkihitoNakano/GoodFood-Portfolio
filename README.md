...
前回作成した俳句を投稿して交流できる SNS、Paiku575 というアプリもお時間がある際はご覧いただけると幸いです。
...
> <span style="font-size:70%"><u>※ Next.js のバックエンドと CRUD 処理を行う本来のバックエンドとを区別するために Next のバックエンドにはバックエンド\_Next と CRUD 処理を行うバックエンドはそのまま、バックエンドと記述します</u></span>
